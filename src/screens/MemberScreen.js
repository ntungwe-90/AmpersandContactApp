      ...
      <View style={styles.profileInfo}>
        ...
        <View style={styles.profile}>
          ...
          <View style={styles.name}>
            <Text style={styles.bio}>JUNIOR NTUNGWE</Text>
            <Text style={styles.position}>Sales Executive</Text>
          </View>
        </View>
        </TouchableOpacity>
        ...
        <View  style={styles.address}>
          ...
          <Text style={styles.addressInfo}>+0016742003</Text>
        </View>

        <View style={styles.address}>
          <MaterialIcons name="mail-outline" size={20} color="black" />
          <Text   style={styles.addressInfo}>Ntungs@gmail.com</Text>
        </View>

        <View style={styles.address}>
          <SimpleLineIcons name="location-pin" size={20} color="black" />
          <Text style={styles.addressInfo}>Toronto,Canada</Text>
        </View>
      </View>
    </View>
  );
